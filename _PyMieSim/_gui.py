...
import base64
import webbrowser
from gui_section import SourceSection, ScattererSection, DetectorSection, MeasureSection
from gui_helper import interface
...
class OpticalSetupGUI:
    ...
    def setup_layout(self):
        ...
        self.app.layout = html.Div([
            ...
            html.Div([
                html.H1("Optical Simulation Interface - Prueba 1", style={'text-align': 'center'}),
            ...
            html.Div([
                html.H1("Visualization - Prueba 2", style={'text-align': 'center'}),
